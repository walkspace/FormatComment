...
{
    [Command(PackageIds.FormatCommentLineTabRightCommand)]
    internal sealed class FormatCommentLineTabRightCommand : BaseCommand<FormatCommentLineTabRightCommand>
    {
